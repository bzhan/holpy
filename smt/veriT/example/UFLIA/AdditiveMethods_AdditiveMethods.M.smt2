...
(declare-fun block1768_2_block1785_correct () Int)
...
(declare-fun block1768_correct () Int)
...
(declare-fun false1751to1768_correct () Int)
...
(declare-fun block1785_correct () Int)
...
(declare-fun block1751_correct () Int)
...
(declare-fun true1751to1785_2_block1785_correct () Int)
...
(assert (let ((?v_0 (select2 Heap_ this ownerFrame_)) (?v_1 (select2 Heap_ this ownerRef_)) (?v_2 (not (= this nullObject))) (?v_5 (select2 Heap_ this AdditiveMethods.amPeer)) (?v_3 (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_ ?o_ ownerRef_) (select2 Heap_3_ ?o_ ownerRef_)) (= (select2 Heap_ ?o_ ownerFrame_) (select2 Heap_3_ ?o_ ownerFrame_)))))) (?v_4 (= ReallyLastGeneratedExit_correct Smt.true)) (?v_25 (= block1785_correct Smt.true)) (?v_28 (= stack0o_0 nullObject)) (?v_6 (not (= stack0o_1 nullObject))) (?v_7 (select2 Heap_ stack0o_1 ownerFrame_)) (?v_8 (select2 Heap_ stack0o_1 ownerRef_))) (let ((?v_9 (or (= ?v_7 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_ ?v_8 inv_) ?v_7)) (= (select2 Heap_ ?v_8 localinv_) (BaseClass_ ?v_7)))) (?v_10 (forall ((?pc_ Int)) (let ((?v_36 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (= (select2 Heap_ ?pc_ allocated_) Smt.true) true) (= (select2 Heap_ ?pc_ ownerRef_) ?v_8) (= (select2 Heap_ ?pc_ ownerFrame_) ?v_7)) (and (= (select2 Heap_ ?pc_ inv_) ?v_36) (= (select2 Heap_ ?pc_ localinv_) ?v_36)))))) (?v_16 (= (select2 Heap_0_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true)) (?v_11 (not (= stack0o_2 nullObject))) (?v_12 (select2 Heap_0_ stack0o_2 ownerFrame_)) (?v_13 (select2 Heap_0_ stack0o_2 ownerRef_))) (let ((?v_14 (or (= ?v_12 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_0_ ?v_13 inv_) ?v_12)) (= (select2 Heap_0_ ?v_13 localinv_) (BaseClass_ ?v_12)))) (?v_15 (forall ((?pc_ Int)) (let ((?v_37 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (= (select2 Heap_0_ ?pc_ allocated_) Smt.true) true) (= (select2 Heap_0_ ?pc_ ownerRef_) ?v_13) (= (select2 Heap_0_ ?pc_ ownerFrame_) ?v_12)) (and (= (select2 Heap_0_ ?pc_ inv_) ?v_37) (= (select2 Heap_0_ ?pc_ localinv_) ?v_37)))))) (?v_24 (= (select2 Heap_1_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true)) (?v_17 (not (= stack0o_3 nullObject))) (?v_18 (select2 Heap_1_ stack0o_3 ownerFrame_)) (?v_19 (select2 Heap_1_ stack0o_3 ownerRef_))) (let ((?v_21 (or (= ?v_18 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_1_ ?v_19 inv_) ?v_18)) (= (select2 Heap_1_ ?v_19 localinv_) (BaseClass_ ?v_18)))) (?v_20 (typeof_ stack0o_3))) (let ((?v_22 (= (select2 Heap_1_ stack0o_3 inv_) ?v_20)) (?v_23 (= (select2 Heap_1_ stack0o_3 localinv_) ?v_20)) (?v_29 (=> true ?v_25)) (?v_26 (= block1768_2_block1785_correct Smt.true)) (?v_27 (= block1768_correct Smt.true)) (?v_32 (= false1751to1768_correct Smt.true)) (?v_30 (= true1751to1785_2_block1785_correct Smt.true)) (?v_31 (= true1751to1785_correct Smt.true)) (?v_33 (= block1751_correct Smt.true)) (?v_34 (= block1734_correct Smt.true)) (?v_35 (= entry_correct Smt.true))) (not (=> (=> (=> true (=> (= (IsHeap Heap_) Smt.true) (=> (= BeingConstructed_ nullObject) (=> (and (or (= ?v_0 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_ ?v_1 inv_) ?v_0)) (= (select2 Heap_ ?v_1 localinv_) (BaseClass_ ?v_0))) (forall ((?pc_ Int)) (let ((?v_38 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (= (select2 Heap_ ?pc_ allocated_) Smt.true) true) (= (select2 Heap_ ?pc_ ownerRef_) ?v_1) (= (select2 Heap_ ?pc_ ownerFrame_) ?v_0)) (and (= (select2 Heap_ ?pc_ inv_) ?v_38) (= (select2 Heap_ ?pc_ localinv_) ?v_38)))))) (=> true (=> (= (IsNotNull_ this AdditiveMethods) Smt.true) (=> (= (= (select2 Heap_ this allocated_) Smt.true) true) (=> true (=> (=> (=> true (=> true (=> true (=> (=> (=> true (=> true (and ?v_2 (=> ?v_2 (=> (= stack0o_0 ?v_5) (=> true (=> (and (=> (=> true (=> true (=> true (=> (=> (=> true (and ?v_3 (=> ?v_3 (=> true true)))) ?v_4) ?v_4)))) ?v_25) (=> (=> true (=> true (=> (not ?v_28) (=> true (=> (=> (=> true (=> true (and ?v_2 (=> ?v_2 (=> (= stack0o_1 ?v_5) (and ?v_6 (=> ?v_6 (and ?v_9 ?v_10 (=> (and ?v_9 ?v_10) (=> (= (IsHeap Heap_0_) Smt.true) (=> (forall ((?o_ Int)) (let ((?v_39 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_ ?o_ allocated_) Smt.true) (not true)) (= (= (select2 Heap_0_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_0_ ?o_ inv_) ?v_39) (= (select2 Heap_0_ ?o_ localinv_) ?v_39))))) (=> (forall ((?o_ Int)) (! (let ((?v_40 (select2 Heap_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_ ?v_40 exposeVersion_) (select2 Heap_0_ ?v_40 exposeVersion_)) (= ?v_40 (select2 Heap_0_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_0_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_ ?o_ ownerRef_) (select2 Heap_0_ ?o_ ownerRef_)) (= (select2 Heap_ ?o_ ownerFrame_) (select2 Heap_0_ ?o_ ownerFrame_))))) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_41 (select2 Heap_ ?o_ ownerFrame_)) (?v_42 (select2 Heap_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (= (select2 Heap_ ?o_ allocated_) Smt.true) true) (or (= ?v_41 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_ ?v_42 inv_) ?v_41)) (= (select2 Heap_ ?v_42 localinv_) (BaseClass_ ?v_41))) true (or (not (= ?o_ stack0o_1)) (not (= ?f_ exposeVersion_)))) (= (select2 Heap_ ?o_ ?f_) (select2 Heap_0_ ?o_ ?f_)))) :pattern ((select2 Heap_0_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (or (and (= (select2 Heap_ ?o_ inv_) (select2 Heap_0_ ?o_ inv_)) (= (select2 Heap_ ?o_ localinv_) (select2 Heap_0_ ?o_ localinv_))) (= (= (select2 Heap_ ?o_ allocated_) Smt.true) (not true)))) (=> (and (forall ((?o_ Int)) (=> (= (= (select2 Heap_ ?o_ allocated_) Smt.true) true) (= (= (select2 Heap_0_ ?o_ allocated_) Smt.true) true))) (forall ((?ot_ Int)) (let ((?v_43 (select2 Heap_ ?ot_ ownerFrame_))) (=> (and (= (= (select2 Heap_ ?ot_ allocated_) Smt.true) true) (not (= ?v_43 PeerGroupPlaceholder_))) (and (= (select2 Heap_0_ ?ot_ ownerRef_) (select2 Heap_ ?ot_ ownerRef_)) (= (select2 Heap_0_ ?ot_ ownerFrame_) ?v_43))))) (= (= (select2 Heap_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true) ?v_16)) (=> (forall ((?o_ Int)) (= (select2 Heap_ ?o_ sharingMode_) (select2 Heap_0_ ?o_ sharingMode_))) (and ?v_2 (=> ?v_2 (=> (= stack0o_2 (select2 Heap_0_ this AdditiveMethods.amPeer)) (and ?v_11 (=> ?v_11 (and ?v_14 ?v_15 (=> (and ?v_14 ?v_15) (=> (= (IsHeap Heap_1_) Smt.true) (=> (forall ((?o_ Int)) (let ((?v_44 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_0_ ?o_ allocated_) Smt.true) (not true)) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_1_ ?o_ inv_) ?v_44) (= (select2 Heap_1_ ?o_ localinv_) ?v_44))))) (=> (forall ((?o_ Int)) (! (let ((?v_45 (select2 Heap_0_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_0_ ?v_45 exposeVersion_) (select2 Heap_1_ ?v_45 exposeVersion_)) (= ?v_45 (select2 Heap_1_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_1_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_0_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_0_ ?o_ ownerRef_) (select2 Heap_1_ ?o_ ownerRef_)) (= (select2 Heap_0_ ?o_ ownerFrame_) (select2 Heap_1_ ?o_ ownerFrame_))))) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_46 (select2 Heap_0_ ?o_ ownerFrame_)) (?v_47 (select2 Heap_0_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (= (select2 Heap_0_ ?o_ allocated_) Smt.true) true) (or (= ?v_46 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_0_ ?v_47 inv_) ?v_46)) (= (select2 Heap_0_ ?v_47 localinv_) (BaseClass_ ?v_46))) true (or (not (= ?o_ stack0o_2)) (not (= ?f_ exposeVersion_)))) (= (select2 Heap_0_ ?o_ ?f_) (select2 Heap_1_ ?o_ ?f_)))) :pattern ((select2 Heap_1_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (or (and (= (select2 Heap_0_ ?o_ inv_) (select2 Heap_1_ ?o_ inv_)) (= (select2 Heap_0_ ?o_ localinv_) (select2 Heap_1_ ?o_ localinv_))) (= (= (select2 Heap_0_ ?o_ allocated_) Smt.true) (not true)))) (=> (and (forall ((?o_ Int)) (=> (= (= (select2 Heap_0_ ?o_ allocated_) Smt.true) true) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true))) (forall ((?ot_ Int)) (let ((?v_48 (select2 Heap_0_ ?ot_ ownerFrame_))) (=> (and (= (= (select2 Heap_0_ ?ot_ allocated_) Smt.true) true) (not (= ?v_48 PeerGroupPlaceholder_))) (and (= (select2 Heap_1_ ?ot_ ownerRef_) (select2 Heap_0_ ?ot_ ownerRef_)) (= (select2 Heap_1_ ?ot_ ownerFrame_) ?v_48))))) (= ?v_16 ?v_24)) (=> (forall ((?o_ Int)) (= (select2 Heap_0_ ?o_ sharingMode_) (select2 Heap_1_ ?o_ sharingMode_))) (and ?v_2 (=> ?v_2 (=> (= stack0o_3 (select2 Heap_1_ this AdditiveMethods.amPeer)) (and ?v_17 (=> ?v_17 (and ?v_21 ?v_22 ?v_23 (=> (and ?v_21 ?v_22 ?v_23) (=> (= (IsHeap Heap_2_) Smt.true) (=> (forall ((?o_ Int)) (let ((?v_49 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) (not true)) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_2_ ?o_ inv_) ?v_49) (= (select2 Heap_2_ ?o_ localinv_) ?v_49))))) (=> (forall ((?o_ Int)) (! (let ((?v_50 (select2 Heap_1_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_1_ ?v_50 exposeVersion_) (select2 Heap_2_ ?v_50 exposeVersion_)) (= ?v_50 (select2 Heap_2_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_2_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_1_ ?o_ ownerRef_) (select2 Heap_2_ ?o_ ownerRef_)) (= (select2 Heap_1_ ?o_ ownerFrame_) (select2 Heap_2_ ?o_ ownerFrame_))))) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_51 (select2 Heap_1_ ?o_ ownerFrame_)) (?v_52 (select2 Heap_1_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true) (or (= ?v_51 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_1_ ?v_52 inv_) ?v_51)) (= (select2 Heap_1_ ?v_52 localinv_) (BaseClass_ ?v_51))) true (or (not (= ?o_ stack0o_3)) (not (= ?f_ exposeVersion_)))) (= (select2 Heap_1_ ?o_ ?f_) (select2 Heap_2_ ?o_ ?f_)))) :pattern ((select2 Heap_2_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (or (and (= (select2 Heap_1_ ?o_ inv_) (select2 Heap_2_ ?o_ inv_)) (= (select2 Heap_1_ ?o_ localinv_) (select2 Heap_2_ ?o_ localinv_))) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) (not true)))) (=> (and (forall ((?o_ Int)) (=> (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) true))) (forall ((?ot_ Int)) (let ((?v_53 (select2 Heap_1_ ?ot_ ownerFrame_))) (=> (and (= (= (select2 Heap_1_ ?ot_ allocated_) Smt.true) true) (not (= ?v_53 PeerGroupPlaceholder_))) (and (= (select2 Heap_2_ ?ot_ ownerRef_) (select2 Heap_1_ ?ot_ ownerRef_)) (= (select2 Heap_2_ ?ot_ ownerFrame_) ?v_53))))) (= ?v_24 (= (select2 Heap_2_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true))) (=> (forall ((?o_ Int)) (= (select2 Heap_1_ ?o_ sharingMode_) (select2 Heap_2_ ?o_ sharingMode_))) (=> true (=> (=> (=> true (=> (= Heap_3_ Heap_2_) (=> (= stack0o_4 stack0o_3) ?v_29))) ?v_26) ?v_26))))))))))))))))))))))))))))))))))))))))))))))))) ?v_27) ?v_27))))) ?v_32) (=> (=> true (=> true (=> ?v_28 (=> true (=> (=> (=> true (=> (= Heap_3_ Heap_) (=> (= stack0o_4 stack0o_0) ?v_29))) ?v_30) ?v_30))))) ?v_31)) (and ?v_31 ?v_32)))))))) ?v_33) ?v_33)))) ?v_34) ?v_34))))))))) ?v_35) ?v_35))))))))
(check-sat)
(exit)
