...
(set-logic UFLIA)
(set-info :source |
  This benchmark originally named "SExpressionSimplifier.Atom..ctor$System.String$notnull.smt2"
...
(declare-fun block26384_correct () Int)
...
(declare-fun block26486_correct () Int)
...
(declare-fun call33627formal__result_0 () Int)
...
(declare-fun call33627formal__result () Int)
...
(assert (forall ((?a Int) (?i Int) (?heap Int)) (let ((?v_0 (RefArrayGet (select2 ?heap ?a elements_) ?i))) (=> (and (= (IsHeap ?heap) Smt.true) (not (= ?v_0 nullObject))) (subtypes (typeof_ ?v_0) (ElementType_ (typeof_ ?a)))))))
...
(assert (let ((?v_3 (select2 Heap_ this ownerRef_)) (?v_4 (select2 Heap_ this ownerFrame_))) (let ((?v_2 (= ?v_4 PeerGroupPlaceholder_)) (?v_0 (select2 Heap_ s_in ownerFrame_)) (?v_1 (select2 Heap_ s_in ownerRef_))) (let ((?v_5 (or (= ?v_0 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_ ?v_1 inv_) ?v_0)) (= (select2 Heap_ ?v_1 localinv_) (BaseClass_ ?v_0)))) (?v_6 (forall ((?pc_ Int)) (let ((?v_33 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (select2 Heap_ ?pc_ allocated_) Smt.true) (= (select2 Heap_ ?pc_ ownerRef_) ?v_1) (= (select2 Heap_ ?pc_ ownerFrame_) ?v_0)) (and (= (select2 Heap_ ?pc_ inv_) ?v_33) (= (select2 Heap_ ?pc_ localinv_) ?v_33))))))) (let ((?v_7 (and ?v_5 ?v_6)) (?v_15 (typeof_ this)) (?v_12 (= (IsHeap Heap_0_) Smt.true)) (?v_8 (= (IsNotNull_ call33627formal__result_0 System.String) Smt.true)) (?v_9 (select2 Heap_0_ call33627formal__result_0 ownerFrame_)) (?v_10 (select2 Heap_0_ call33627formal__result_0 ownerRef_)) (?v_16 (= (select2 Heap_0_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true)) (?v_11 (not (= this nullObject))) (?v_13 (select2 Heap_1_ this ownerFrame_)) (?v_14 (select2 Heap_1_ this ownerRef_)) (?v_17 (= (select2 Heap_1_ this inv_) SExpressionSimplifier.Sx))) (let ((?v_18 (= (select2 Heap_1_ this localinv_) ?v_15)) (?v_19 (forall ((?p_ Int)) (let ((?v_34 (typeof_ ?p_))) (=> (and (not (= ?p_ nullObject)) (= (select2 Heap_1_ ?p_ allocated_) Smt.true) (= (select2 Heap_1_ ?p_ ownerRef_) this) (= (select2 Heap_1_ ?p_ ownerFrame_) SExpressionSimplifier.Atom)) (and (= (select2 Heap_1_ ?p_ inv_) ?v_34) (= (select2 Heap_1_ ?p_ localinv_) ?v_34)))))) (?v_20 (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_35 (select2 Heap_ ?o_ ownerFrame_)) (?v_36 (select2 Heap_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (select2 Heap_ ?o_ allocated_) Smt.true) (or (= ?v_35 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_ ?v_36 inv_) ?v_35)) (= (select2 Heap_ ?v_36 localinv_) (BaseClass_ ?v_35))) (or (not (= ?o_ this)) (not (subtypes SExpressionSimplifier.Atom (DeclType ?f_)))) true true) (= (select2 Heap_ ?o_ ?f_) (select2 Heap_2_ ?o_ ?f_)))) :pattern ((select2 Heap_2_ ?o_ ?f_)) ))) (?v_21 (= (select2 Heap_2_ this sharingMode_) SharingMode_Unshared_)) (?v_25 (select2 Heap_2_ this ownerRef_))) (let ((?v_22 (= ?v_25 ?v_3)) (?v_24 (select2 Heap_2_ this ownerFrame_))) (let ((?v_23 (= ?v_24 ?v_4)) (?v_26 (or (= ?v_24 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_2_ ?v_25 inv_) ?v_24)) (= (select2 Heap_2_ ?v_25 localinv_) (BaseClass_ ?v_24)))) (?v_27 (= (select2 Heap_2_ this inv_) SExpressionSimplifier.Atom)) (?v_28 (= (select2 Heap_2_ this localinv_) ?v_15)) (?v_29 (= ReallyLastGeneratedExit_correct Smt.true)) (?v_30 (= block26486_correct Smt.true)) (?v_31 (= block26384_correct Smt.true)) (?v_32 (= entry_correct Smt.true))) (not (=> (=> (=> true (=> (= (IsHeap Heap_) Smt.true) (=> (= (IsNotNull_ s_in System.String) Smt.true) (=> (= BeingConstructed_ this) (=> (forall ((?o_ Int)) (=> (and (= (select2 Heap_ ?o_ ownerRef_) ?v_3) (= (select2 Heap_ ?o_ ownerFrame_) ?v_4)) (= ?o_ this))) (=> (and (= ?v_3 this) ?v_2) (=> (forall ((?o_ Int)) (=> (not (= ?o_ this)) (not (= (select2 Heap_ ?o_ ownerRef_) this)))) (=> ?v_7 (=> (= (select2 Heap_ s_in allocated_) Smt.true) (=> true (=> (= (IsNotNull_ this SExpressionSimplifier.Atom) Smt.true) (=> (= (select2 Heap_ this allocated_) Smt.true) (=> (and (or ?v_2 (not (subtypes (select2 Heap_ ?v_3 inv_) ?v_4)) (= (select2 Heap_ ?v_3 localinv_) (BaseClass_ ?v_4))) (= (select2 Heap_ this inv_) System.Object) (= (select2 Heap_ this localinv_) ?v_15)) (=> true (=> (=> (=> true (=> true (=> true (=> (=> (=> true (=> true (=> (= (IsNotNull_ call33627formal__result System.String) Smt.true) (and ?v_5 ?v_6 (=> ?v_7 (=> ?v_12 (=> ?v_8 (=> (= (select2 Heap_0_ call33627formal__result_0 allocated_) Smt.true) (=> ?v_8 (=> (and (or (= ?v_9 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_0_ ?v_10 inv_) ?v_9)) (= (select2 Heap_0_ ?v_10 localinv_) (BaseClass_ ?v_9))) (forall ((?pc_ Int)) (let ((?v_37 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (select2 Heap_0_ ?pc_ allocated_) Smt.true) (= (select2 Heap_0_ ?pc_ ownerRef_) ?v_10) (= (select2 Heap_0_ ?pc_ ownerFrame_) ?v_9)) (and (= (select2 Heap_0_ ?pc_ inv_) ?v_37) (= (select2 Heap_0_ ?pc_ localinv_) ?v_37)))))) (=> (forall ((?o_ Int)) (! (let ((?v_38 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (not (= (select2 Heap_ ?o_ allocated_) Smt.true)) (= (select2 Heap_0_ ?o_ allocated_) Smt.true)) (and (= (select2 Heap_0_ ?o_ inv_) ?v_38) (= (select2 Heap_0_ ?o_ localinv_) ?v_38)))) :pattern ((select2 Heap_0_ ?o_ localinv_))  :pattern ((select2 Heap_0_ ?o_ inv_)) )) (=> (forall ((?o_ Int)) (! (let ((?v_39 (select2 Heap_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_ ?v_39 exposeVersion_) (select2 Heap_0_ ?v_39 exposeVersion_)) (= ?v_39 (select2 Heap_0_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_0_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_40 (select2 Heap_ ?o_ ownerFrame_)) (?v_41 (select2 Heap_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (select2 Heap_ ?o_ allocated_) Smt.true) (or (= ?v_40 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_ ?v_41 inv_) ?v_40)) (= (select2 Heap_ ?v_41 localinv_) (BaseClass_ ?v_40))) true true) (= (select2 Heap_ ?o_ ?f_) (select2 Heap_0_ ?o_ ?f_)))) :pattern ((select2 Heap_0_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (! (=> (= (select2 Heap_ ?o_ allocated_) Smt.true) (and (= (select2 Heap_ ?o_ inv_) (select2 Heap_0_ ?o_ inv_)) (= (select2 Heap_ ?o_ localinv_) (select2 Heap_0_ ?o_ localinv_)))) :pattern ((select2 Heap_0_ ?o_ localinv_))  :pattern ((select2 Heap_0_ ?o_ inv_)) )) (=> (and (forall ((?o_ Int)) (! (=> (= (select2 Heap_ ?o_ allocated_) Smt.true) (= (select2 Heap_0_ ?o_ allocated_) Smt.true)) :pattern ((select2 Heap_0_ ?o_ allocated_)) )) (forall ((?ot_ Int)) (! (let ((?v_42 (select2 Heap_ ?ot_ ownerFrame_))) (=> (and (= (select2 Heap_ ?ot_ allocated_) Smt.true) (not (= ?v_42 PeerGroupPlaceholder_))) (and (= (select2 Heap_ ?ot_ ownerRef_) (select2 Heap_0_ ?ot_ ownerRef_)) (= ?v_42 (select2 Heap_0_ ?ot_ ownerFrame_))))) :pattern ((select2 Heap_0_ ?ot_ ownerFrame_))  :pattern ((select2 Heap_0_ ?ot_ ownerRef_)) )) (= (= (select2 Heap_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true) ?v_16)) (=> (forall ((?o_ Int)) (! (= (select2 Heap_ ?o_ sharingMode_) (select2 Heap_0_ ?o_ sharingMode_)) :pattern ((select2 Heap_0_ ?o_ sharingMode_)) )) (and ?v_11 (=> ?v_11 (=> (= (select2 Heap_0_ this SExpressionSimplifier.Atom.S) call33627formal__result_0) (=> ?v_12 (and ?v_11 (=> ?v_11 (=> (= (IsHeap Heap_1_) Smt.true) (=> (and (or (= ?v_13 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_1_ ?v_14 inv_) ?v_13)) (= (select2 Heap_1_ ?v_14 localinv_) (BaseClass_ ?v_13))) ?v_17 ?v_18) (=> (and (= ?v_14 (select2 Heap_0_ this ownerRef_)) (= ?v_13 (select2 Heap_0_ this ownerFrame_))) (=> (= (select2 Heap_1_ this sharingMode_) SharingMode_Unshared_) (=> (forall ((?o_ Int)) (! (let ((?v_43 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (not (= (select2 Heap_0_ ?o_ allocated_) Smt.true)) (= (select2 Heap_1_ ?o_ allocated_) Smt.true)) (and (= (select2 Heap_1_ ?o_ inv_) ?v_43) (= (select2 Heap_1_ ?o_ localinv_) ?v_43)))) :pattern ((select2 Heap_1_ ?o_ localinv_))  :pattern ((select2 Heap_1_ ?o_ inv_)) )) (=> (forall ((?o_ Int)) (! (let ((?v_44 (select2 Heap_0_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_0_ ?v_44 exposeVersion_) (select2 Heap_1_ ?v_44 exposeVersion_)) (= ?v_44 (select2 Heap_1_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_1_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_45 (select2 Heap_0_ ?o_ ownerFrame_)) (?v_46 (select2 Heap_0_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (select2 Heap_0_ ?o_ allocated_) Smt.true) (or (= ?v_45 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_0_ ?v_46 inv_) ?v_45)) (= (select2 Heap_0_ ?v_46 localinv_) (BaseClass_ ?v_45))) (or (not (= ?o_ this)) (not (subtypes SExpressionSimplifier.Sx (DeclType ?f_)))) true true) (= (select2 Heap_0_ ?o_ ?f_) (select2 Heap_1_ ?o_ ?f_)))) :pattern ((select2 Heap_1_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (! (=> (and (= (select2 Heap_0_ ?o_ allocated_) Smt.true) (not (= ?o_ this))) (and (= (select2 Heap_0_ ?o_ inv_) (select2 Heap_1_ ?o_ inv_)) (= (select2 Heap_0_ ?o_ localinv_) (select2 Heap_1_ ?o_ localinv_)))) :pattern ((select2 Heap_1_ ?o_ localinv_))  :pattern ((select2 Heap_1_ ?o_ inv_)) )) (=> (and (forall ((?o_ Int)) (! (=> (= (select2 Heap_0_ ?o_ allocated_) Smt.true) (= (select2 Heap_1_ ?o_ allocated_) Smt.true)) :pattern ((select2 Heap_1_ ?o_ allocated_)) )) (forall ((?ot_ Int)) (! (let ((?v_47 (select2 Heap_0_ ?ot_ ownerFrame_))) (=> (and (= (select2 Heap_0_ ?ot_ allocated_) Smt.true) (not (= ?v_47 PeerGroupPlaceholder_))) (and (= (select2 Heap_0_ ?ot_ ownerRef_) (select2 Heap_1_ ?ot_ ownerRef_)) (= ?v_47 (select2 Heap_1_ ?ot_ ownerFrame_))))) :pattern ((select2 Heap_1_ ?ot_ ownerFrame_))  :pattern ((select2 Heap_1_ ?ot_ ownerRef_)) )) (= ?v_16 (= (select2 Heap_1_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true))) (=> (forall ((?o_ Int)) (! (or (= ?o_ this) (= (select2 Heap_0_ ?o_ sharingMode_) (select2 Heap_1_ ?o_ sharingMode_))) :pattern ((select2 Heap_1_ ?o_ sharingMode_)) )) (and ?v_11 (=> ?v_11 (and ?v_17 ?v_18 (=> (and ?v_17 ?v_18) (and ?v_19 (=> ?v_19 (=> (= Heap_2_ (store2 Heap_1_ this inv_ SExpressionSimplifier.Atom)) (=> (= (IsHeap Heap_2_) Smt.true) (=> true (=> (=> (=> true (and ?v_20 (=> ?v_20 (and ?v_21 (=> ?v_21 (and ?v_22 ?v_23 (=> (and ?v_22 ?v_23) (and ?v_26 ?v_27 ?v_28 (=> (and ?v_26 ?v_27 ?v_28) (=> true true)))))))))) ?v_29) ?v_29)))))))))))))))))))))))))))))))))))))))))) ?v_30) ?v_30)))) ?v_31) ?v_31))))))))))))))) ?v_32) ?v_32))))))))))
(check-sat)
(exit)
