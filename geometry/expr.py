...
class Prover:
    ...
    def apply_rule(self, rule_name: str, facts: Sequence[Fact]) -> bool:
        """Apply given rule to the list of facts.

        If param facts is a list of integers: these integers represents the positions in hyps.
        In this case, hyps must be a list of facts. The new facts generated by this function
        will combine to hyps automatically.
        
        Function returns a fact implying the conclusion if it is found.
    ...
    def search_step(self, only_updated=False) -> None:
        ...
        for rule_name, rule in self.ruleset.items():
            ...
            # print(rule_name, len(applicable_facts_list))
            for facts in applicable_facts_list:
                ...
                res = self.apply_rule(rule_name, facts)
                if res is not None:
                    return res
