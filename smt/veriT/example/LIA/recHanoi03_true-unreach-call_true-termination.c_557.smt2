...
(assert
 (and
 (exists ((|v_hanoi_#t~ret0_13| Int) (v_nnf_32 Int) (v_nnf_33 Int))
  (and (<= |c_hanoi_#in~n| 4) 
  (<= 1 v_nnf_32) (<= (+ (* 2 v_nnf_32) 1) v_nnf_33)
  (<= (+ (* 2 v_nnf_33) 1) |v_hanoi_#t~ret0_13|)
  (<= (+ (* 2 |v_hanoi_#t~ret0_13|) 1) |c_hanoi_#res|)))
