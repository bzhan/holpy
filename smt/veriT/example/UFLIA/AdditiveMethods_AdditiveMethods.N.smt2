...
(declare-fun block2550_correct () Int)
...
(declare-fun true2533to2584_2_block2584_correct () Int)
(declare-fun block2618_correct () Int)
...
(declare-fun block2465_correct () Int)
...
(declare-fun false2533to2550_correct () Int)
...
(declare-fun block2533_correct () Int)
...
(assert (let ((?v_0 (select2 Heap_ this ownerFrame_)) (?v_1 (select2 Heap_ this ownerRef_))) (let ((?v_5 (or (= ?v_0 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_ ?v_1 inv_) ?v_0)) (= (select2 Heap_ ?v_1 localinv_) (BaseClass_ ?v_0)))) (?v_2 (not (= this nullObject))) (?v_3 (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_ ?o_ ownerRef_) (select2 Heap_6_ ?o_ ownerRef_)) (= (select2 Heap_ ?o_ ownerFrame_) (select2 Heap_6_ ?o_ ownerFrame_)))))) (?v_4 (= ReallyLastGeneratedExit_correct Smt.true)) (?v_31 (= block2584_correct Smt.true)) (?v_36 (= stack0o_0 nullObject)) (?v_27 (TypeObject AdditiveMethods)) (?v_6 (subtypes (select2 Heap_ this inv_) AdditiveMethods)) (?v_30 (typeof_ this))) (let ((?v_7 (= (select2 Heap_ this localinv_) ?v_30)) (?v_8 (not (= stack0o_1 nullObject))) (?v_9 (select2 Heap_1_ stack0o_1 ownerFrame_)) (?v_10 (select2 Heap_1_ stack0o_1 ownerRef_))) (let ((?v_11 (or (= ?v_9 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_1_ ?v_10 inv_) ?v_9)) (= (select2 Heap_1_ ?v_10 localinv_) (BaseClass_ ?v_9)))) (?v_12 (forall ((?pc_ Int)) (let ((?v_44 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (= (select2 Heap_1_ ?pc_ allocated_) Smt.true) true) (= (select2 Heap_1_ ?pc_ ownerRef_) ?v_10) (= (select2 Heap_1_ ?pc_ ownerFrame_) ?v_9)) (and (= (select2 Heap_1_ ?pc_ inv_) ?v_44) (= (select2 Heap_1_ ?pc_ localinv_) ?v_44)))))) (?v_18 (= (select2 Heap_2_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true)) (?v_13 (not (= stack0o_2 nullObject))) (?v_14 (select2 Heap_2_ stack0o_2 ownerFrame_)) (?v_15 (select2 Heap_2_ stack0o_2 ownerRef_))) (let ((?v_16 (or (= ?v_14 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_2_ ?v_15 inv_) ?v_14)) (= (select2 Heap_2_ ?v_15 localinv_) (BaseClass_ ?v_14)))) (?v_17 (forall ((?pc_ Int)) (let ((?v_45 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (= (select2 Heap_2_ ?pc_ allocated_) Smt.true) true) (= (select2 Heap_2_ ?pc_ ownerRef_) ?v_15) (= (select2 Heap_2_ ?pc_ ownerFrame_) ?v_14)) (and (= (select2 Heap_2_ ?pc_ inv_) ?v_45) (= (select2 Heap_2_ ?pc_ localinv_) ?v_45)))))) (?v_26 (= (select2 Heap_3_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true)) (?v_19 (not (= stack0o_3 nullObject))) (?v_20 (select2 Heap_3_ stack0o_3 ownerFrame_)) (?v_21 (select2 Heap_3_ stack0o_3 ownerRef_))) (let ((?v_23 (or (= ?v_20 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_3_ ?v_21 inv_) ?v_20)) (= (select2 Heap_3_ ?v_21 localinv_) (BaseClass_ ?v_20)))) (?v_22 (typeof_ stack0o_3))) (let ((?v_24 (= (select2 Heap_3_ stack0o_3 inv_) ?v_22)) (?v_25 (= (select2 Heap_3_ stack0o_3 localinv_) ?v_22)) (?v_28 (= (select2 Heap_4_ this localinv_) System.Object)) (?v_29 (forall ((?p_ Int)) (let ((?v_46 (typeof_ ?p_))) (=> (and (not (= ?p_ nullObject)) (= (= (select2 Heap_4_ ?p_ allocated_) Smt.true) true) (= (select2 Heap_4_ ?p_ ownerRef_) this) (= (select2 Heap_4_ ?p_ ownerFrame_) AdditiveMethods)) (and (= (select2 Heap_4_ ?p_ inv_) ?v_46) (= (select2 Heap_4_ ?p_ localinv_) ?v_46)))))) (?v_37 (=> true ?v_31)) (?v_32 (= block2618_2_block2584_correct Smt.true)) (?v_33 (= block2618_correct Smt.true)) (?v_34 (= block2567_correct Smt.true)) (?v_35 (= block2550_correct Smt.true)) (?v_40 (= false2533to2550_correct Smt.true)) (?v_38 (= true2533to2584_2_block2584_correct Smt.true)) (?v_39 (= true2533to2584_correct Smt.true)) (?v_41 (= block2533_correct Smt.true)) (?v_42 (= block2465_correct Smt.true)) (?v_43 (= entry_correct Smt.true))) (not (=> (=> (=> true (=> (= (IsHeap Heap_) Smt.true) (=> (= BeingConstructed_ nullObject) (=> (and ?v_5 (forall ((?pc_ Int)) (let ((?v_47 (typeof_ ?pc_))) (=> (and (not (= ?pc_ nullObject)) (= (= (select2 Heap_ ?pc_ allocated_) Smt.true) true) (= (select2 Heap_ ?pc_ ownerRef_) ?v_1) (= (select2 Heap_ ?pc_ ownerFrame_) ?v_0)) (and (= (select2 Heap_ ?pc_ inv_) ?v_47) (= (select2 Heap_ ?pc_ localinv_) ?v_47)))))) (=> true (=> (= (IsNotNull_ this AdditiveMethods) Smt.true) (=> (= (= (select2 Heap_ this allocated_) Smt.true) true) (=> true (=> (=> (=> true (=> true (=> true (=> (=> (=> true (=> true (and ?v_2 (=> ?v_2 (=> (= stack0o_0 (select2 Heap_ this AdditiveMethods.amRep)) (=> true (=> (and (=> (=> true (=> true (=> true (=> (=> (=> true (and ?v_3 (=> ?v_3 (=> true true)))) ?v_4) ?v_4)))) ?v_31) (=> (=> true (=> true (=> (not ?v_36) (=> true (=> (=> (=> true (=> true (=> (= (IsTokenForType_ stack1s_0 AdditiveMethods) Smt.true) (=> (= stack1o_0 ?v_27) (and ?v_2 (=> ?v_2 (and ?v_5 ?v_6 ?v_7 (=> (and ?v_5 ?v_6 ?v_7) (=> (= Heap_0_ (store2 Heap_ this localinv_ System.Object)) (=> (= Heap_1_ (store2 Heap_0_ this exposeVersion_ temp0_0)) (=> (= (IsHeap Heap_1_) Smt.true) (=> true (=> (=> (=> true (=> true (and ?v_2 (=> ?v_2 (=> (= stack0o_1 (select2 Heap_1_ this AdditiveMethods.amRep)) (and ?v_8 (=> ?v_8 (and ?v_11 ?v_12 (=> (and ?v_11 ?v_12) (=> (= (IsHeap Heap_2_) Smt.true) (=> (forall ((?o_ Int)) (let ((?v_48 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) (not true)) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_2_ ?o_ inv_) ?v_48) (= (select2 Heap_2_ ?o_ localinv_) ?v_48))))) (=> (forall ((?o_ Int)) (! (let ((?v_49 (select2 Heap_1_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_1_ ?v_49 exposeVersion_) (select2 Heap_2_ ?v_49 exposeVersion_)) (= ?v_49 (select2 Heap_2_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_2_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_1_ ?o_ ownerRef_) (select2 Heap_2_ ?o_ ownerRef_)) (= (select2 Heap_1_ ?o_ ownerFrame_) (select2 Heap_2_ ?o_ ownerFrame_))))) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_50 (select2 Heap_1_ ?o_ ownerFrame_)) (?v_51 (select2 Heap_1_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true) (or (= ?v_50 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_1_ ?v_51 inv_) ?v_50)) (= (select2 Heap_1_ ?v_51 localinv_) (BaseClass_ ?v_50))) true (or (not (= ?o_ stack0o_1)) (not (= ?f_ exposeVersion_)))) (= (select2 Heap_1_ ?o_ ?f_) (select2 Heap_2_ ?o_ ?f_)))) :pattern ((select2 Heap_2_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (or (and (= (select2 Heap_1_ ?o_ inv_) (select2 Heap_2_ ?o_ inv_)) (= (select2 Heap_1_ ?o_ localinv_) (select2 Heap_2_ ?o_ localinv_))) (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) (not true)))) (=> (and (forall ((?o_ Int)) (=> (= (= (select2 Heap_1_ ?o_ allocated_) Smt.true) true) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) true))) (forall ((?ot_ Int)) (let ((?v_52 (select2 Heap_1_ ?ot_ ownerFrame_))) (=> (and (= (= (select2 Heap_1_ ?ot_ allocated_) Smt.true) true) (not (= ?v_52 PeerGroupPlaceholder_))) (and (= (select2 Heap_2_ ?ot_ ownerRef_) (select2 Heap_1_ ?ot_ ownerRef_)) (= (select2 Heap_2_ ?ot_ ownerFrame_) ?v_52))))) (= (= (select2 Heap_1_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true) ?v_18)) (=> (forall ((?o_ Int)) (= (select2 Heap_1_ ?o_ sharingMode_) (select2 Heap_2_ ?o_ sharingMode_))) (and ?v_2 (=> ?v_2 (=> (= stack0o_2 (select2 Heap_2_ this AdditiveMethods.amRep)) (and ?v_13 (=> ?v_13 (and ?v_16 ?v_17 (=> (and ?v_16 ?v_17) (=> (= (IsHeap Heap_3_) Smt.true) (=> (forall ((?o_ Int)) (let ((?v_53 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) (not true)) (= (= (select2 Heap_3_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_3_ ?o_ inv_) ?v_53) (= (select2 Heap_3_ ?o_ localinv_) ?v_53))))) (=> (forall ((?o_ Int)) (! (let ((?v_54 (select2 Heap_2_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_2_ ?v_54 exposeVersion_) (select2 Heap_3_ ?v_54 exposeVersion_)) (= ?v_54 (select2 Heap_3_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_3_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_2_ ?o_ ownerRef_) (select2 Heap_3_ ?o_ ownerRef_)) (= (select2 Heap_2_ ?o_ ownerFrame_) (select2 Heap_3_ ?o_ ownerFrame_))))) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_55 (select2 Heap_2_ ?o_ ownerFrame_)) (?v_56 (select2 Heap_2_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) true) (or (= ?v_55 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_2_ ?v_56 inv_) ?v_55)) (= (select2 Heap_2_ ?v_56 localinv_) (BaseClass_ ?v_55))) true (or (not (= ?o_ stack0o_2)) (not (= ?f_ exposeVersion_)))) (= (select2 Heap_2_ ?o_ ?f_) (select2 Heap_3_ ?o_ ?f_)))) :pattern ((select2 Heap_3_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (or (and (= (select2 Heap_2_ ?o_ inv_) (select2 Heap_3_ ?o_ inv_)) (= (select2 Heap_2_ ?o_ localinv_) (select2 Heap_3_ ?o_ localinv_))) (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) (not true)))) (=> (and (forall ((?o_ Int)) (=> (= (= (select2 Heap_2_ ?o_ allocated_) Smt.true) true) (= (= (select2 Heap_3_ ?o_ allocated_) Smt.true) true))) (forall ((?ot_ Int)) (let ((?v_57 (select2 Heap_2_ ?ot_ ownerFrame_))) (=> (and (= (= (select2 Heap_2_ ?ot_ allocated_) Smt.true) true) (not (= ?v_57 PeerGroupPlaceholder_))) (and (= (select2 Heap_3_ ?ot_ ownerRef_) (select2 Heap_2_ ?ot_ ownerRef_)) (= (select2 Heap_3_ ?ot_ ownerFrame_) ?v_57))))) (= ?v_18 ?v_26)) (=> (forall ((?o_ Int)) (= (select2 Heap_2_ ?o_ sharingMode_) (select2 Heap_3_ ?o_ sharingMode_))) (and ?v_2 (=> ?v_2 (=> (= stack0o_3 (select2 Heap_3_ this AdditiveMethods.amRep)) (and ?v_19 (=> ?v_19 (and ?v_23 ?v_24 ?v_25 (=> (and ?v_23 ?v_24 ?v_25) (=> (= (IsHeap Heap_4_) Smt.true) (=> (forall ((?o_ Int)) (let ((?v_58 (typeof_ ?o_))) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_3_ ?o_ allocated_) Smt.true) (not true)) (= (= (select2 Heap_4_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_4_ ?o_ inv_) ?v_58) (= (select2 Heap_4_ ?o_ localinv_) ?v_58))))) (=> (forall ((?o_ Int)) (! (let ((?v_59 (select2 Heap_3_ ?o_ FirstConsistentOwner_))) (=> (= (select2 Heap_3_ ?v_59 exposeVersion_) (select2 Heap_4_ ?v_59 exposeVersion_)) (= ?v_59 (select2 Heap_4_ ?o_ FirstConsistentOwner_)))) :pattern ((select2 Heap_4_ ?o_ FirstConsistentOwner_)) )) (=> (forall ((?o_ Int)) (=> (and (not (= ?o_ nullObject)) (= (= (select2 Heap_3_ ?o_ allocated_) Smt.true) true)) (and (= (select2 Heap_3_ ?o_ ownerRef_) (select2 Heap_4_ ?o_ ownerRef_)) (= (select2 Heap_3_ ?o_ ownerFrame_) (select2 Heap_4_ ?o_ ownerFrame_))))) (=> (forall ((?o_ Int) (?f_ Int)) (! (let ((?v_60 (select2 Heap_3_ ?o_ ownerFrame_)) (?v_61 (select2 Heap_3_ ?o_ ownerRef_))) (=> (and (not (= ?f_ inv_)) (not (= ?f_ localinv_)) (not (= ?f_ FirstConsistentOwner_)) (or (not (= (IsStaticField ?f_) Smt.true)) (not (= (IsDirectlyModifiableField ?f_) Smt.true))) (not (= ?o_ nullObject)) (= (= (select2 Heap_3_ ?o_ allocated_) Smt.true) true) (or (= ?v_60 PeerGroupPlaceholder_) (not (subtypes (select2 Heap_3_ ?v_61 inv_) ?v_60)) (= (select2 Heap_3_ ?v_61 localinv_) (BaseClass_ ?v_60))) true (or (not (= ?o_ stack0o_3)) (not (= ?f_ exposeVersion_)))) (= (select2 Heap_3_ ?o_ ?f_) (select2 Heap_4_ ?o_ ?f_)))) :pattern ((select2 Heap_4_ ?o_ ?f_)) )) (=> (forall ((?o_ Int)) (or (and (= (select2 Heap_3_ ?o_ inv_) (select2 Heap_4_ ?o_ inv_)) (= (select2 Heap_3_ ?o_ localinv_) (select2 Heap_4_ ?o_ localinv_))) (= (= (select2 Heap_3_ ?o_ allocated_) Smt.true) (not true)))) (=> (and (forall ((?o_ Int)) (=> (= (= (select2 Heap_3_ ?o_ allocated_) Smt.true) true) (= (= (select2 Heap_4_ ?o_ allocated_) Smt.true) true))) (forall ((?ot_ Int)) (let ((?v_62 (select2 Heap_3_ ?ot_ ownerFrame_))) (=> (and (= (= (select2 Heap_3_ ?ot_ allocated_) Smt.true) true) (not (= ?v_62 PeerGroupPlaceholder_))) (and (= (select2 Heap_4_ ?ot_ ownerRef_) (select2 Heap_3_ ?ot_ ownerRef_)) (= (select2 Heap_4_ ?ot_ ownerFrame_) ?v_62))))) (= ?v_26 (= (select2 Heap_4_ BeingConstructed_ NonNullFieldsAreInitialized_) Smt.true))) (=> (forall ((?o_ Int)) (= (select2 Heap_3_ ?o_ sharingMode_) (select2 Heap_4_ ?o_ sharingMode_))) (=> true (=> (=> (=> true (=> true (=> (= (IsTokenForType_ stack1s_1 AdditiveMethods) Smt.true) (=> (= stack1o_1 ?v_27) (and ?v_2 (=> ?v_2 (and ?v_28 (=> ?v_28 (and ?v_29 (=> ?v_29 (=> (= Heap_5_ (store2 Heap_4_ this localinv_ ?v_30)) (=> (= (IsHeap Heap_5_) Smt.true) (=> true (=> (=> (=> true (=> (= Heap_6_ Heap_5_) (=> (= stack1s_2 stack1s_1) (=> (= temp0_1 temp0_0) (=> (= stack0o_4 this) (=> (= stack1o_2 stack1o_1) (=> (= local0_0 this) ?v_37))))))) ?v_32) ?v_32)))))))))))))) ?v_33) ?v_33))))))))))))))))))))))))))))))))))))))))))))))))) ?v_34) ?v_34))))))))))))) ?v_35) ?v_35))))) ?v_40) (=> (=> true (=> true (=> ?v_36 (=> true (=> (=> (=> true (=> (= Heap_6_ Heap_) (=> (= stack1s_2 stack1s) (=> (= temp0_1 temp0) (=> (= stack0o_4 stack0o_0) (=> (= stack1o_2 nullObject) (=> (= local0_0 local0) ?v_37))))))) ?v_38) ?v_38))))) ?v_39)) (and ?v_39 ?v_40)))))))) ?v_41) ?v_41)))) ?v_42) ?v_42))))))))) ?v_43) ?v_43))))))))))
(check-sat)
(exit)
